  ...
  },
{
  ...
  
 {
  ...
  },
  {
    ...
    {
    slug: "fortinet-fortigate-nse4",
    title: "Fortinet FortiGate Firewall (NSE 4)",
    path: "network-security",
    level: "Intermediate",
    duration: "3 Months",
    delivery: "Live Online",
    tagline: "Configure and administer FortiGate next-generation firewalls from initial setup to HA clustering — aligned with the NSE 4 certification blueprint.",
    overview: "A comprehensive, hands-on course covering FortiGate deployment, security policies, NAT, routing, VPNs, security profiles, and high availability — everything you need to operate FortiGate in production environments.",
    whoShouldEnroll: ["Network engineers moving into security", "IT administrators managing FortiGate", "Anyone targeting NSE 4 certification"],
    skills: {
      technical: ["FortiGate policy configuration", "NAT & routing", "IPsec/SSL VPNs", "HA clustering", "SSL/SSH inspection"],
      professional: ["Firewall troubleshooting", "Security policy design", "Network documentation"],
    },
    tools: ["FortiGate", "FortiManager", "FortiAnalyzer", "FSSO"],
    curriculum: [
      { title: "Introduction to Fortinet Ecosystem & Initial Setup", desc: "FortiGate hardware, VM deployment, initial configuration, and management interfaces." },
      { title: "FortiGate Interfaces, Zones, and VLANs", desc: "Configuring physical and virtual interfaces, firewall zones, and VLAN segmentation." },
      { title: "Firewall Security Policies & Troubleshooting", desc: "Building policies, understanding policy matching order, and debugging traffic flow." },
      { title: "Network Address Translation (NAT & PAT)", desc: "Source NAT, destination NAT, port forwarding, and NAT troubleshooting." },
      { title: "Routing Configurations & SD-WAN Deployment", desc: "Static routing, OSPF, BGP basics, and SD-WAN rule configuration." },
      { title: "Security Profiles (Antivirus, Web Filtering, Application Control)", desc: "Deploying UTM profiles to inspect and control traffic." },
      { title: "Deep Packet SSL/SSH Inspection", desc: "Certificate management, inspection policies, and bypass configurations." },
      { title: "User Authentication & Single Sign-On (FSSO)", desc: "Local users, LDAP/AD integration, and FSSO agent deployment." },
      { title: "Virtual Private Networks (IPsec & SSL VPN)", desc: "Site-to-site tunnels, remote access SSL VPN, and split tunneling." },
      { title: "High Availability (HA) Clustering", desc: "Active-passive and active-active HA setup, failover testing, and configuration sync." },
      { title: "Logging, Monitoring, and Diagnostics", desc: "FortiAnalyzer integration, log analysis, and diagnostic commands." },
    ],
    labs: ["Initial FortiGate setup lab", "Firewall policy troubleshooting", "Site-to-site VPN deployment", "HA failover testing"],
    projects: ["Deploy a production-ready FortiGate with full security stack and HA"],
    careerOutcomes: ["Network Security Engineer", "Firewall Administrator", "NOC Analyst"],
    faqs: [
      { q: "Is this an official Fortinet certification course?", a: "This is independent Hackverge training aligned with NSE 4 topics, not an official Fortinet certification." },
      { q: "Do I need a physical FortiGate?", a: "No — the course uses FortiGate VM in a lab environment." },
    ],
  },
  {
    slug: "cisco-ccna-networking",
    title: "Cisco CCNA Networking",
    path: "network-security",
    level: "Beginner",
    duration: "3 Months",
    delivery: "Live Online",
    tagline: "Build the networking foundation every security professional needs — switching, routing, ACLs, wireless, and automation basics, aligned to CCNA 200-301.",
    overview: "Covers the full CCNA blueprint: network fundamentals, IP addressing, switching, routing, security basics, wireless, and automation — the foundation that makes every other security course click.",
    whoShouldEnroll: ["Beginners entering cybersecurity", "IT support staff moving into security", "Anyone who needs a solid networking foundation"],
    skills: {
      technical: ["VLANs & inter-VLAN routing", "OSPFv2 configuration", "ACLs & NAT", "Device hardening", "Basic automation concepts"],
      professional: ["Network troubleshooting", "Configuration documentation", "Understanding network diagrams"],
    },
    tools: ["Cisco IOS", "Packet Tracer", "GNS3"],
    curriculum: [
      { title: "Network Fundamentals & OSI/TCP-IP Models", desc: "How data moves across networks, protocol layers, and encapsulation." },
      { title: "IP Addressing, Subnetting (VLSM), and IPv6", desc: "IPv4 math, subnet design, and IPv6 addressing fundamentals." },
      { title: "Ethernet Switching, VLANs, and Inter-VLAN Routing", desc: "Switch operation, VLAN configuration, and router-on-a-stick." },
      { title: "Spanning Tree Protocol (STP) & EtherChannel", desc: "Loop prevention, STP modes, and link aggregation." },
      { title: "IP Routing Concepts & OSPFv2 Configuration", desc: "Static routes, dynamic routing basics, and OSPF single-area configuration." },
      { title: "First Hop Redundancy Protocols (FHRP/HSRP)", desc: "Gateway redundancy with HSRP and VRRP." },
      { title: "Network Access Control Lists (ACLs) & NAT", desc: "Standard and extended ACLs, NAT configurations, and PAT." },
      { title: "Device Management (SSH, SNMP, Syslog)", desc: "Secure management, monitoring, and logging configuration." },
      { title: "Network Security Fundamentals", desc: "Threat landscape, security planes, and device hardening basics." },
      { title: "Wireless Networking Basics (WLAN Architecture)", desc: "Wi-Fi standards, access point configuration, and security." },
      { title: "Introduction to Network Automation & Programmability", desc: "REST APIs, JSON, Python basics, and configuration management concepts." },
    ],
    labs: ["Subnetting practice", "VLAN and trunking lab", "OSPF configuration", "ACL troubleshooting"],
    projects: ["Design and configure a multi-site network with routing, security, and redundancy"],
    careerOutcomes: ["Network Engineer", "NOC Technician", "IT Support Specialist", "Foundation for all security roles"],
    faqs: [
      { q: "Do I need physical Cisco equipment?", a: "No — the course uses Cisco Packet Tracer and GNS3 for all labs." },
      { q: "Will this prepare me for the CCNA exam?", a: "Yes, the curriculum aligns with CCNA 200-301 topics, though this is not an official Cisco course." },
    ],
  },
  {
    slug: "sophos-firewall-administration",
    title: "Sophos Firewall Administration",
    path: "network-security",
    level: "Intermediate",
    duration: "2 Months",
    delivery: "Live Online",
    tagline: "Deploy and administer Sophos Firewall end-to-end: network protection, web/application control, ATP, decryption, VPNs, and Security Heartbeat.",
    overview: "Hands-on training covering Sophos Firewall deployment, policy configuration, advanced threat protection, SSL inspection, VPNs, and centralized management through Sophos Central.",
    whoShouldEnroll: ["Network engineers moving into security", "IT administrators managing Sophos", "Learners on the Network Security path"],
    skills: {
      technical: ["Firewall rules & NAT", "Web/application control", "ATP & zero-day protection", "SSL/TLS inspection", "Site-to-site & remote VPNs"],
      professional: ["Security policy design", "Threat investigation", "Sophos Central reporting"],
    },
    tools: ["Sophos Firewall (SFOS)", "Sophos Central", "RED"],
    curriculum: [
      { title: "Sophos Firewall Architecture & Initial Deployment", desc: "Platform overview, deployment modes, and initial configuration." },
      { title: "Network Topology Setup (Zones, Interfaces, and Routing)", desc: "Configuring network zones, interfaces, and routing policies." },
      { title: "Network Protection (Firewall Rules, NAT, and DoS Protection)", desc: "Building firewall rules, NAT configurations, and DoS protection." },
      { title: "Web Protection, Application Control, and Cloud Applications", desc: "Web filtering, application control, and cloud app visibility." },
      { title: "Advanced Threat Protection (ATP) & Zero-Day Guard", desc: "Sandbox analysis, ATP policies, and zero-day threat prevention." },
      { title: "Decryption and SSL/TLS Inspection", desc: "Certificate management, decryption policies, and privacy considerations." },
      { title: "User Authentication & Active Directory Integration", desc: "Local users, AD/LDAP integration, and SSO configuration." },
      { title: "Site-to-Site and Remote Access VPNs (RED, SSL, IPsec)", desc: "VPN deployment, remote access, and RED appliance configuration." },
      { title: "Synchronized Security (Sophos Security Heartbeat)", desc: "Endpoint-firewall integration and automated threat response." },
      { title: "Logging, Reporting (Sophos Central), and Troubleshooting", desc: "Log analysis, reporting, and diagnostic tools." },
    ],
    labs: ["Initial deployment lab", "Firewall policy troubleshooting", "SSL inspection configuration", "VPN deployment"],
    projects: ["Deploy Sophos Firewall with full security stack and centralized management"],
    careerOutcomes: ["Network Security Engineer", "Firewall Administrator", "Security Operations Analyst"],
    faqs: [
      { q: "Do I need Sophos hardware?", a: "No — the course uses Sophos Firewall virtual appliance in a lab environment." },
    ],
  },
  {
    slug: "cisco-firewall-ftd-firepower",
    title: "Cisco Firewall FTD (Firepower Threat Defense)",
    path: "network-security",
    level: "Intermediate",
    duration: "3 Months",
    delivery: "Live Online",
    tagline: "Master Cisco's next-generation firewall: FMC management, FTD deployment modes, access-control policy, Snort 3 IPS, AMP, and failover design.",
    overview: "Comprehensive training on Cisco Firepower Threat Defense — from FMC setup and FTD deployment to advanced access-control policies, Snort 3 IPS tuning, AMP, and high availability.",
    whoShouldEnroll: ["Network engineers moving into security", "Firewall administrators managing Cisco FTD", "Learners on the Network Security path"],
    skills: {
      technical: ["FMC management", "FTD deployment modes", "Access-control & prefilter policies", "Snort 3 IPS", "AMP & URL filtering", "HA failover"],
      professional: ["Policy tuning", "Threat investigation", "Firewall documentation"],
    },
    tools: ["Cisco FTD", "Firepower Management Center (FMC)", "Snort 3"],
    curriculum: [
      { title: "Introduction to Cisco Next-Generation Firewalls (NGFW)", desc: "FTD architecture, deployment models, and comparison to ASA." },
      { title: "Cisco Firepower Management Center (FMC) Setup & Licensing", desc: "FMC deployment, device registration, and licensing." },
      { title: "FTD Deployment Modes (Routed, Transparent, Inline)", desc: "Choosing and configuring deployment modes for different use cases." },
      { title: "Object Management & Interface Configuration", desc: "Network objects, port objects, and interface configuration." },
      { title: "Access Control Policies & Prefilter Rules", desc: "Building access-control policies, prefilter optimization, and rule tuning." },
      { title: "Network Address Translation (NAT) on FTD", desc: "Manual and auto NAT, identity NAT, and NAT troubleshooting." },
      { title: "Security Intelligence & URL Filtering", desc: "Block/allow lists, reputation-based filtering, and URL filtering policies." },
      { title: "Next-Gen IPS (Snort 3) & Advanced Malware Protection (AMP)", desc: "IPS policy tuning, Snort 3 features, and AMP file inspection." },
      { title: "High Availability (Failover) for FTD", desc: "Active/standby failover configuration and testing." },
      { title: "Site-to-Site & Remote Access VPN Deployments", desc: "IPsec site-to-site tunnels and remote access VPN configuration." },
      { title: "FTD Maintenance, Reporting, and Troubleshooting", desc: "System updates, reporting, and diagnostic tools." },
    ],
    labs: ["FMC/FTD deployment", "Access-control policy tuning", "Snort 3 IPS configuration", "HA failover testing"],
    projects: ["Deploy FTD with full security stack, IPS, and HA in a simulated enterprise environment"],
    careerOutcomes: ["Network Security Engineer", "Firewall Administrator", "Security Operations Engineer"],
    faqs: [
      { q: "Do I need physical Cisco firewalls?", a: "No — the course uses FTDv (virtual) and FMCv in a lab environment." },
      { q: "Is this an official Cisco certification course?", a: "This is independent Hackverge training on FTD, not an official Cisco certification." },
    ],
  },
  {
    slug: "palo-alto-networks-pcnse",
    title: "Palo Alto Networks PCNSE",
    path: "network-security",
    level: "Intermediate",
    duration: "3 Months",
    delivery: "Live Online",
    tagline: "Administer Palo Alto Networks next-gen firewalls toward PCNSE: App-ID/Content-ID, User-ID, decryption, WildFire, GlobalProtect, HA, and Panorama.",
    overview: "Comprehensive training on Palo Alto Networks PAN-OS — from initial configuration to advanced features like App-ID, decryption, WildFire, GlobalProtect VPNs, HA, and Panorama centralized management.",
    whoShouldEnroll: ["Network engineers moving into security", "Firewall administrators managing Palo Alto", "Anyone targeting PCNSE certification"],
    skills: {
      technical: ["Security policy with App-ID/Content-ID", "User-ID authentication", "SSL decryption", "WildFire threat prevention", "GlobalProtect VPNs", "HA configuration"],
      professional: ["Policy design", "Threat investigation", "Panorama management"],
    },
    tools: ["PAN-OS", "Panorama", "GlobalProtect", "WildFire"],
    curriculum: [
      { title: "Palo Alto Architecture & Single-Pass Parallel Processing (SP3)", desc: "Platform architecture, SP3 processing, and traffic flow." },
      { title: "Initial Configuration, Interfaces, and Virtual Routers", desc: "Initial setup, interface configuration, and virtual router design." },
      { title: "Security Zones & Security Policy Configurations", desc: "Zone design, security policies, and policy optimization." },
      { title: "Network Address Translation (NAT Rules)", desc: "Source NAT, destination NAT, and NAT troubleshooting." },
      { title: "App-ID™ & Content-ID™ Implementation", desc: "Application identification, content filtering, and file blocking." },
      { title: "URL Filtering & User-ID™ Authentication", desc: "URL filtering policies, User-ID agent deployment, and authentication." },
      { title: "Decryption Policies (Inbound & Forward Proxy)", desc: "SSL/TLS decryption, certificate management, and privacy considerations." },
      { title: "WildFire™ (Advanced Threat Prevention)", desc: "Sandbox analysis, WildFire policies, and threat intelligence." },
      { title: "GlobalProtect™ Remote Access & Site-to-Site VPNs", desc: "GlobalProtect deployment, portal/gateway configuration, and site-to-site IPsec." },
      { title: "High Availability (Active/Passive & Active/Active)", desc: "HA pair configuration, failover testing, and configuration sync." },
      { title: "Panorama™ Centralized Management Overview", desc: "Panorama deployment, template management, and centralized policy push." },
    ],
    labs: ["Initial PA deployment", "App-ID/Content-ID policy tuning", "SSL decryption configuration", "GlobalProtect deployment"],
    projects: ["Deploy Palo Alto firewall with full security stack, HA, and Panorama management"],
    careerOutcomes: ["Network Security Engineer", "Firewall Administrator", "Security Operations Engineer"],
    faqs: [
      { q: "Do I need physical Palo Alto firewalls?", a: "No — the course uses PA-VM (virtual) in a lab environment." },
      { q: "Will this prepare me for the PCNSE exam?", a: "Yes, the curriculum aligns with PCNSE topics, though this is not an official Palo Alto Networks course." },
    ],
  },
];
